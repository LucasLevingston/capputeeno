         ...
         <div className="h-full w-full bg-[#F0F0F5] px-5 py-[34px] md:px-40 min-h-screen">
            <div className='space-y-4'>
               ...
               <div className='flex flex-col sm:flex-row'>
                  <div className='sm:p-6 sm:w-[60%]  space-y-3 p-1 w-full '>
                     <div className='flex justify-between sm:w-[90%]'>
                        <div>
                  ...
                  <div className='bg-white sm:w-[30%]   p-6 flex flex-col justify-between h-[700px]'>
